...
declare const _default: (params?: ButtonStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "variants" | "disabled" | "loading">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"root" | "variants" | "disabled" | "loading", string>;
