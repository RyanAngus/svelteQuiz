...
declare const _default: (params?: DividerStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"label" | "horizontal" | "vertical" | "root" | "showsLabel">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"label" | "horizontal" | "vertical" | "root" | "showsLabel", string>;
