...
declare const _default: (params?: InputStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "invalid" | "icon" | "root" | "disabled" | "rightSection" | "defaultVariant" | "filledVariant" | "unstyledVariant" | "withIcon">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "invalid" | "icon" | "root" | "disabled" | "rightSection" | "defaultVariant" | "filledVariant" | "unstyledVariant" | "withIcon", string>;
